...
function Header() {
    ...
    <section className='xl:flex'>
        ...
        <div className='bg-yellow rounded-b-lg flex md:px-24 xl:px-0 xl:flex-1'>
            <div className='flex-column py-10 px-6 px-15 xl:pl-40 xl:pr-12'>
                <h2 className='text-xl md:text-2xl xl:text-3xl xl:leading-72 xl:w-50 md:leading-10 font-semibold mb-4 text-center xl:text-left'>Have you Ever Struggled to Communicate Your Full Potential?</h2>
                <p className='text-txt9 md:text-lg text-center xl:text-left'>At EmpowerMe, we understand the challenges you face when it comes to
