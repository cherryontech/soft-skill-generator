...
const SimpleStepsBox: React.FC<SimpleStepsBoxProps> = ({
  ...
  return (
    <div className={`relative flex flex-col items-center w-52 bg-darkPurple mt-5 md:mt-30 py-30 px-5 rounded-lg h-auto xl:w-full ${className}`}>
      ...
      <div>
        ...
        <div className="flex justify-center items-center text-white">
          <p className="flex justify-center text-txt10 md:text-base xl:text-lg">{paragraph}</p>
        </div>
      </div>
    </div>
  );
